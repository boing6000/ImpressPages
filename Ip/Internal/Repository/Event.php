...
class Event
{
    public static function ipBeforeController()
    {
        ...
        if (ipIsManagementState() || ipRoute()->isAdmin() || ipRequest()->getQuery('ipDesignPreview')) {
            ...
            ipAddJs('Ip/Internal/Repository/assets/bootpag.js');

            $marketUrl = 'https://pixabay.com/';//ipConfig()->get('imageMarketUrl', ipConfig()->protocol() . '://market.impresspages.org/images-v1/');
