<div class="ip ipsModuleRepositoryPopup">
    <div class="ipModuleRepositoryPopup">
        ...
        <ul class="nav nav-tabs ipsTabs">
            <li class="active"><a href="#ipsModuleRepositoryTabUpload"
                                  data-toggle="tab"><?php _e('File repository', 'Ip-admin'); ?></a></li>
            <li class="<?php echo $allowUpload ? '' : 'hidden' ?>"><a href="#ipsModuleRepositoryTabBuy"
                                                                      data-toggle="tab"><?php _e('Imagens de Pixabay', 'Ip-admin'); ?></a>
            </li>
        </ul>
            ...
            <div id="ipsModuleRepositoryTabUpload" class="tab-pane active _tabUpload">
                            ...
                            <form class="_form ipsBrowserSearch" action="">
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control ipsTerm"
                                           placeholder="<?php _e('Search by filename', 'Ip-admin'); ?>">
                                    <span class="input-group-btn">
                                        <button class="btn btn-default ipsSubmit" type="submit"><i
                ...
                <div class="_repositoryActions ipsRepositoryActions hidden">
                    <div class="_container">
                        <span class="_title"><?php _e('Selected:', 'Ip-admin'); ?> <strong
                                    class="ipsSelectionCount"></strong></span>
                        ...
                        <button class="btn btn-danger btn-sm ipsSelectionDelete"><?php _e('Delete', 'Ip-admin'); ?><i
                                    class="fa fa-fw fa-trash-o"></i></button>
                    </div>
                </div>
                <?php // hidden templates for dynamic elements ?>
                <div class="hidden">
                    <h2 class=" ipsListTitle ipsListTitleTemplate"></h2>
                ...
                <div class="debugError"></div>
            </div>

            <div id="ipsModuleRepositoryTabBuy" class="tab-pane _tabBuy" data-marketurl="<?php echo $marketUrl; ?>">
                <div class="_container pixabay" style="overflow-y: auto; overflow-x: hidden;" id="ipsModuleRepositoryTabBuyContainer">
                    <div class="container-fluid pixabay" style="margin-top: 5px;">
                        <div class="row">
                            <div class="col-md-12">
                                <img src="https://pixabay.com/static/img/logo.png" class="col-md-2 img-responsive">
                                <form class="_form ipsBrowserPixabay" action="">
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control ipsTerm"
                                               placeholder="<?php _e('Buscar imagem pelo Pixabay', 'Ip-admin'); ?>">
                        ...
                        <div class="row" style="margin-top: 15px;">
                            <div class="col-lg-12">
                                <h1 class="page-header">Resultados para: </h1>
                            </div>
                            <div class="pixabayImages row"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 pixabayPagination"></div>
                        </div>
                    </div>
                </div>
