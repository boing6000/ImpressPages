...
DROP TABLE IF EXISTS `ip_kbMail`;

CREATE TABLE IF NOT EXISTS `ip_kbMail`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `itemOrder` double,
  `from` varchar(255),
  `constact` varchar(255),
  `subject` varchar(255),
  `body` text,
  `date` datetime,
  `attachments` text,
...
DROP TABLE IF EXISTS `kos_port_cat`;

CREATE TABLE IF NOT EXISTS `kos_port_cat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `itemOrder` double,
  `name` varchar(255),
  `language` varchar(7),
...
DROP TABLE IF EXISTS `kos_port`;

CREATE TABLE IF NOT EXISTS `kos_port` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `itemOrder` double,
  `catId` int(11),
  `title` varchar(255),
...
ALTER TABLE `ip_page` add kbNewsId int(11) default null
ALTER TABLE `ip_page` add kbNewsIdParent int(11) default null