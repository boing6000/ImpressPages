...
*/ ?>
        ...
        <div class="_widgets ipsWidgetList">
            ...
            <div class="_container ipsAdminPanelWidgetsContainer">
                <?php $scrollWidth = count($widgets)*(95 + 2*4); // to keep all elements on one line ?>
...
<script>
    $(document).ready(function(){
        ...
        var containerWidth = scrollableAPI.getRoot().width() - (itemWidth); // adding left side compensation
        var scrollBy = Math.floor(containerWidth / itemWidth) +2; // define number of items to scroll
